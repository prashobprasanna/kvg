...
<body>
    ...
    <section class="inner-banner wow fadeIn" data-wow-delay=".2s" style="padding:0">
        <div><img src="images/banner/aboutus.jpg" class="img-responsive"></div>
    </section>
...
.conainer {
    ...
    margin: 100px auto;
                ...
                <center>
                    <div class="card1">
                        <div class="img">
                            <img src="admin-kvgce/photos/kurunji.jpg" style="padding:0;max-width:fit-content;width:400px;">
                        </div>
                        <div class="infos">
                            <div class="name">
                                <strong>
                                    <div class="header-fullname" style="font-size: 25px;">Late. Dr. Kurunji Venkatramana Gowda</div>
                                </strong>
                            ...
                            <ul class="stats1">
                                <li>
                                    <blockquote>
                                        "It takes a lot of courage to release the familiar and seemingly secure, to embrace the new. But there is no real security in what is no longer meaningful. There is more security in the adventurous and exciting, for in movement there is life, and in change there is power." </blockquote>
                                </li>
                            </ul>
                            <div class="links1">
        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <center>
                    <div class="card1">
                        <div class="img">
                            <img src="admin-kvgce/photos/gen_secretary.jpg" style="padding:0;width:600px;">
                        </div>
                        <div class="infos">
                            <div class="name">
                                <strong>
                            ...
                            <ul class="stats1">
                                <li>
                                    <blockquote>
                                        "Dreams pass into the reality of action. From the actions stems the dream again; and this interdependence produces the highest form of living." </blockquote>
                                </li>
                            </ul>
                            <div class="links1">
                                <!-- <button class="follow">Follow</button> -->
        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <center>
                    <div class="card1">
                        <div class="img">
                            <img src="admin-kvgce/photos/faculty/ujwal sir.JPG" style="padding:0;width:900px;">
                        </div>
                        <div class="infos">
                            <div class="name">
                                <strong>
                            ...
                            <ul class="stats1">
                                <li>
                                    <blockquote>
                                        "KVG College of Engineering focuses on addressing the needs of students fromcurricular, co-curricular and extra-curricular point of view. It is the innateprinciple of our institution that every single student must realize her or his goalto be a robust and effective part of the world to solve real world problems and tobe an asset to the society" </blockquote>
                                </li>
                            </ul>
                            <div class="links1">
                                <!-- <button class="follow">Follow</button> -->
        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <center>
                    <div class="card1">
                        <div class="img">
                            <img src="admin-kvgce/photos/suresh.jpg" style="padding:0;width:300px;">
                        </div>
                        <div class="infos">
                            <div class="name">
                                <strong>
                            ...
                            <ul class="stats1">
                                <li>
                                    <blockquote>
                                        "Do not go where the path may lead, go instead where there is no path and leave trail." </blockquote>
                                </li>
                            </ul>
                            <div class="links1">
                                <!-- <button class="follow">Follow</button> -->
