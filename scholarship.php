...
<body>
    ...
    <section class="inner-banner wow fadeIn" data-wow-delay=".2s" style="padding:0">
        <div><img src="images/banner/scholarship.jpg" class="img-responsive"></div>
    </section>
    ...
    <section id="president">
        <div class="container">
            <div class="col-md-12">
                <br>
                <h2 class="subheadWhite head" style="color: #04192e"> Financial Aid & Scholarships<span></span></h2>
                <style>
                    /* body,
html {
    height: 100%;
            ...
            <div class="col-md-12">
                ...
                <div class="card1">
                    ...
                    <ul class="list">
                        ...
                        <li> Post Matric scholarship for Scheduled Caste students (parent income is less than 2.5 lakh)</li>
                        <li> Post Matric scholarship for Scheduled Tribe students (parent income is less than 2.5 lakh)</li>
                        <li> S.J.Jindal Trust Scholarship</li>
                        <li> Children of Beedi Workers Scholarship</li>
                        <li> Children of Cardamom Estate Workers Scholarship</li>
                        <li> Ex-Defence Scholarship</li>
                        <li> Defence Scholarship</li>
                        <li> GOI merit-cum-means Scholarship</li>
                        <li> Teachers Scholarship</li>
                        <li> Al-ameen Trust Scholarship</li>
                        <li> Scholarship for Uppara Jananga students</li>
                        <li> KSWF Scholarship </li>
                        <li>Central Sector Scheme of Merit Scholarship</li>
                        <li>Fee Concession for Scheduled Tribe students (parent income is more than 2.5 lakh) Fee Concession.</li>
                        <li> Fee Concession for Scheduled Caste students (parent income is more than 2.5 lakh)</li>
                        <li> Fee Concession for whose parent income is below 1 Lakhs</li>
                        <li> Fee Concession for Cat-I students </li>
