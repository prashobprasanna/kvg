    ...
    <body>
        ...
        <section id="founder" class="bshadow"><br><br>
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h2 class="head1 pull-right"><span>FOUNDER</span> PRESIDENT</h2>
...
<style>
                        ...
                        .card8 .card8-left .card8-img::before {
                            content: "";
                            background: url(admin-kvgce/photos/gen_secretary1.jpg);
                            width: 80%;
                            height: 100%;
                            background-repeat: no-repeat;
                            background-size: cover;
...
<button onclick="myFunctionuj()" id="myBtnuj"><strong> Read more</strong></button></div><br><br>
<a href="profile/CEO SIR PROFILE (1).pdf" class="card9-link fw-5" style="color:#3A3B3C;"><button style="border-radius:5px;background-color:rgb(30 131 215 / 80%);color:white;padding:8px;">View Profile</button> </a>
