        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <center>
                    <div class="card1">
                        <div class="img">
                            <img src="admin-kvgce/photos/faculty/basic/shiva.jpg" style="width:600px; margin-bottom: 20px;">
                        </div>
                        <div class="infos">
                            <div class="name">
                                <strong>
                                    <div class="header-fullname" id="som">DR. SHIVAKUMAR H R(Deputed to VTU)</div>
                                </strong>
