                                                ...
                                                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                                    <div class="panel panel-default">
                                                        ...
                                                        <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                                            <div class="panel-body">
                                                                <p>"POSH Act: The POSH Act has been enacted with the objective of preventing and protecting women against workplace sexual harassment and to ensure effective redressal of complaints of sexual harassment. The statute aims at providing every woman (irrespective of her age or employment status) a safe, secure and dignified working environment, free from all forms of harassment. The Sexual Harassment of Women at Workplace (Prevention, Prohibition and Redressal) Act, 2013 is a legislative act in India that seeks to protect women from sexual harassment at their place of work. It was passed by the Lok Sabha on 3 September 2012. It was passed by the Rajya Sabha on 26 February 2013." </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading" role="tab" id="headingTwo">
                                                            <h4 class="panel-title"> <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">DEFINITION OF SEXUAL HARASSMENT </a> </h4>
                                                        </div>
                                                        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                                            <div class="panel-body">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li>Any other unwelcome physical, verbal or non-verbal conduct of sexual nature. The college has taken various initiatives to support the Students, Teaching and Non-teaching Staff in the campus. In order to have the best learning and working experience and as per the Law, the college has taken all care to protect and safeguard the students and the employees from any acts of sexual harassment and provide an environment free of gender based discrimination.</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading" role="tab" id="headingThree">
                                                            <h4 class="panel-title"> <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="true" aria-controls="collapseThree"> COMPOSITION OF THE ANTI SEXUAL COMMITTEE </a> </h4>
                                                        </div>
                                                        <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                                                            <div class="panel-body">
                                                                <p>
                                                                    The Committee against Sexual Harassment is formed as part of a larger institutional framework for the creation of a safe campus with utmost focus towards gender equity. The Committee’s chief mandate includes considering complaints or grievances in relation to sexual harassment offences committed on campus and awareness-raising.</p>
                                                                <p>
