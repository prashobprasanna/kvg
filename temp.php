...
<body>
    ...
    <section class="inner-banner wow fadeIn" data-wow-delay=".2s" style="padding:0">
        <div><img src="admin-kvgce/photos/dept slider/placement.jpg" class="img-responsive"></div>
    </section>
                ...
                <center>
                    <div class="card1">
                        ...
                        <div class="infos">
                            <div class="name">
                                <strong>
                                    <div class="header-fullname" id="som">PROF. ANIL B.V</div>
                                </strong>
            ...
            <div class="tabbable-line">
                ...
                <div class="tab-content margin-tops">
                    ...
                    <div class="tab-pane fade team active in" id="abouts">
                        ...
                        <div class="col-md-12">
                            <h1>About<br /><span> Placement Cell </span></h1>
                        ...
                        <div class="container" style="float:left;">
                            ...
                            <div class="col-md-12"><br>
                                <h1><br /> <span>Career Guidance and Higher Education:</span></h1>
                                <section class="inner-page-bg" style="padding:0; height:fit-content;"> <br>
                                    <div class="container inner-page shd" style=" border:3px solid rgb(59, 13, 0); border-radius:18px;margin-left:0%;">
                                        <!-- About Computer Science -->
                                        <div class="conainer">
                                                ...
                                                <div class="col-lg-3 col-md-6">
                                                    <div class="member">
                                                        ...
                                                        <div class="member-info">
                                                            ...
                                                            <span>Asst. Training and Placement Officer</span>
