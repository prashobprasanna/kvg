    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <h3 class="subheadWhite head" style="color: #3A3B3C;padding:0%;">FOUNDER PRESIDENT<span></span></h3>
                <h3 class="head1 pull-right"><strong>LATE Dr. KURUNJI VENKATRAMANA GOWDA</strong></h3>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <h3 class="subheadWhite head" style="color: #3A3B3C;padding:0%;">GENERAL SECRETARY<span></span></h3>
                <h3 class="head1 pull-left" ><strong>Dr. RENUKA PRASAD K V</strong></h3>
                <div class="clearfix"></div><br>
            </div>
            <div class="clearfix"></div><br>
...
<button onclick="myFunction1()" id="myBtn1"><strong> Read more</strong></button>
            </div>
        </div>
    </div>
    <div class="clearfix"></div><br><br>
