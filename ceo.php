...
<body>
    ...
    <section class="inner-banner wow fadeIn" data-wow-delay=".2s" style="padding:0">
        <div><img src="admin-kvgce/images/banner/ceo.jpg" class="img-responsive"></div>
    </section>
    <!-- 
    ...
    <style>
        ...
        .card7 .card7-left .card7-img::before {
            content: "";
            background: url(admin-kvgce/photos/kurunji1.png);
            width: 100%;
            height: 100%;
...
<a href="profile/CEO SIR PROFILE (1).pdf" class="card9-link fw-5" style="color:#3A3B3C;"><strong>View Profile</strong></a>
