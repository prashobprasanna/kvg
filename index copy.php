    ...
    <section class="slider wow fadeIn" data-wow-delay=".2s">
        <div id="carousel-example-generic" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="item slide64"> <img data-src="admin-kvgce/images/banner/2.jpg" src="admin-kvgce/images/banner/2.jpg">
                    <!-- <div class="carousel-caption carousel-caption-1">
                    </div> -->
                </div>
                ...
                <div class="item   slide63"> <img data-src="admin-kvgce/images/banner/3.jpg" src="admin-kvgce/images/banner/3.jpg">
                    <!-- <div class="carousel-caption carousel-caption-1">
                    </div> -->
                </div>
                ...
                <div class="item   slide58"> <img data-src="admin-sjec/photos/slider/58.jpg" src="admin-kvgce/images/banner/5.jpg">
                    <!-- <div class="carousel-caption carousel-caption-1">
                    </div> -->
                </div>


                <div class="item   slide42"> <img data-src="admin-sjec/photos/slider/42.jpg" src="admin-kvgce/images/banner/6.jpg">
                    <!-- <div class="carousel-caption carousel-caption-1">
                    </div> -->
                </div>

                <div class="item   slide35"> <img data-src="admin-sjec/photos/slider/35.jpg" src="admin-kvgce/images/banner/9.jpg">
                    <!-- <div class="carousel-caption carousel-caption-1">
                    </div> -->
                </div>
